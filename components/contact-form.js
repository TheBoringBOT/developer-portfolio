      ...
      <div className="flex flex-wrap -mx-3 mb-6">
        <div className="w-full px-3 my-6 md:mb-0">
          ...
          <input
            ...
            className="appearance-none block w-full bg-light-grey text-black border  border-light-grey rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
            type="text"
            required
            name="name"
            placeholder="Name"
      ...
      <div className="flex flex-wrap -mx-3 mb-6">
        <div className="w-full px-3">
          ...
          <input
            ...
            className="appearance-none block w-full bg-light-grey text-black border border-light-grey rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            type="email"
            name="email"
            required
            placeholder="Email"
      ...
      <div className="flex flex-wrap -mx-3 mb-6">
        <div className="w-full px-3">
          ...
          <textarea
            ...
            className=" no-resize appearance-none block w-full bg-light-grey text-black border border-light-grey  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-48 resize-none"
            required
            name="message"
            maxLength="300"
            placeholder="Message."
